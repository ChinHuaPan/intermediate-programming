...
namespace GoFish
{
    ...
    public class GameController
    {
        ...
        {
            throw new NotImplementedException(); // delete this line once you have completed this TO DO
            IEnumerable<Player> computerPlayersWithCards;
            do
            {
                // TO DO: Determine which players still have cards
                // and store this value in computerPlayersWithCards
