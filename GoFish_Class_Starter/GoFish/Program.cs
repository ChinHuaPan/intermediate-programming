...
namespace GoFish
{
    ...
    class Program
    {
        ...
        static Values PromptForAValue()
        {
            ...
            while (true)
            {
                // Currently, you have to type out Ace, King, Queen, Jack. Try to modify
                // this code so that the player can enter A, K, Q, or J as well.
                // Then, further modify this code so that player input is case-insensitive
                // (i.e., a, k, q, or j will work, too)
